    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          {/* Modal content */}
          <Card className="relative w-full max-w-md mx-4 max-h-[80vh] overflow-hidden">
                    ...
                    <div key={`${item.id}-${forceRender}`} className="flex justify-between items-start p-3 bg-gray-50 rounded-lg">{/* ... rest of item content */}
                      <div className="flex-1">
                        ...
                        <p className="text-sm font-semibold text-primary mt-1">
                          {item.estimatedPrice > 0 ? `${item.estimatedPrice} CHF` : 'Sur devis'}
                        </p>
                      </div>
                      <Button
                        variant="ghost"
                  ...
                  <div className="border-t pt-4">
                    <div className="flex justify-between items-center text-lg font-semibold">
                      ...
                      <span className="text-primary">
                        {totalPrice > 0 ? `${totalPrice} CHF` : 'Sur devis'}
                      </span>
                    </div>
                  </div>
